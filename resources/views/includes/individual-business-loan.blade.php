        ...
        <div class="bg-secondary">
            <div class="container-fluid">
              <ul class="nav secondary-nav">
                ...
                <li class="nav-item"> <a class="nav-link active" href="individual-business-loan"><span><i class="fas fa-credit-card"></i></span> Individual <br>Business<br> Loan</a> </a> </li>
          ...
          <div class="bg-light shadow-md rounded p-4">
            <div class="row">
              ...
              <div class="col-lg-4 mb-4 mb-lg-0">
                <h2 class="text-4 mb-3">Individual Business Loan</h2>
              ...
              <div class="col-lg-8">
                <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut" data-animatein="fadeIn" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-2.jpg')}}" alt="banner 3" /></a></div>
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-1.jpg')}}" alt="banner 4" /></a></div>
                </div>
              </div><!-- Slideshow end -->
        ...
        <div class="section pt-4 pb-3">
          <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab" href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Individual Business Loan</a> </li>
