        ...
        <div class="bg-secondary">
                <div class="container-fluid">
                  <ul class="nav secondary-nav">
                    ...
                    <li class="nav-item"> <a class="nav-link active" href="recharge-bill-broadband"><span><i class="fas fa-wifi"></i></span> Broadband</a> </li>
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut" data-animatein="fadeIn" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-4.jpg')}}" alt="banner 4" /></a></div>
        ...
        <div class="section pt-4 pb-3">
          <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab" href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Broadband Bill Payment</a> </li>
