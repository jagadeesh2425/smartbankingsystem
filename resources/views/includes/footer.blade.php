  ...
  <footer id="footer">
          ...
          <div class="row">
            <div class="col-md-4 mb-3 mb-md-0">
              ...
              <ul class="payments-types">
                <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{('frontend/images/payment/visa.png')}}" alt="visa" title="Visa"></a></li>
                <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{('frontend/images/payment/discover.png')}}" alt="discover" title="Discover"></a></li>
                <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{('frontend/images/payment/paypal.png')}}" alt="paypal" title="PayPal"></a></li>
                <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{('frontend/images/payment/american.png')}}" alt="american express" title="American Express"></a></li>
                <li><a href="#" target="_blank"> <img data-toggle="tooltip" src="{{('frontend/images/payment/mastercard.png')}}" alt="discover" title="Discover"></a></li>
              </ul>
            </div>
            <div class="col-md-4 mb-3 mb-md-0">
              <p>Subscribe</p>
        ...
        <div class="container">
          <div class="footer-copyright">
            ...
            <p class="copyright-text">Copyright © 2018 <a href="#">Smart Banking System</a>. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
      <!-- Footer end --> 
...
<!-- view plans here -->
@include('includes.viewplans-dialog')
<!-- view plans end here-->

<!-- login/signup here -->
@include('includes.loginsignup-dialog')
