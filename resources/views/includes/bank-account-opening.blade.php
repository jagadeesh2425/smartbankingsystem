        ...
        <div class="bg-secondary">
            <div class="container-fluid">
              <ul class="nav secondary-nav">
                ...
                <li class="nav-item"> <a class="nav-link active" href="bank-account-opening"><span><i class="fas fa-plug"></i></span> Bank Account <br>Opening</a> </li>
          ...
          <div class="bg-light shadow-md rounded p-4">
            <div class="row">
              ...
              <div class="col-lg-4 mb-4 mb-lg-0">
                <h2 class="text-4 mb-3">Bank Account Opening</h2>
        ...
        <div class="section pt-4 pb-3">
          <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab" href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Bank Account Opening</a> </li>
