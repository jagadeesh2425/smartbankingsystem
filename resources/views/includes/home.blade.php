        ...
        <div class="bg-secondary">
          <div class="container-fluid">
            <ul class="nav secondary-nav">
              <li class="nav-item"> <a class="nav-link active" href="{{ url('/') }}"><span><i class="fas fa-mobile-alt"></i></span> Mobile</a> </li>
            ...
            <div class="row"> 
              ...
              <div class="col-lg-8">
                <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut" data-animatein="fadeIn" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-1.jpg')}}" alt="banner 1" /></a></div>
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-2.jpg')}}" alt="banner 2" /></a></div>
                </div>
              </div>
              <!-- Slideshow end --> 
