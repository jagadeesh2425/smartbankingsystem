        ...
        <div class="bg-secondary">
                <div class="container-fluid">
                  <ul class="nav secondary-nav">
                    ...
                    <li class="nav-item"> <a class="nav-link active" href="cash-collection-and-bank-account-deposits"><span><i class="fas fa-plug"></i></span> Cash Collection <br> Bank Account deposits</a> </li>
          ...
          <div class="bg-light shadow-md rounded p-4">
            <div class="row">
              ...
              <div class="col-lg-4 mb-4 mb-lg-0">
                <h2 class="text-4 mb-3">Cash Collection and Bank Account deposits</h2>
        ...
        <div class="section pt-4 pb-3">
          <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab" href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Cash Collection and Bank Account deposits</a> </li>
