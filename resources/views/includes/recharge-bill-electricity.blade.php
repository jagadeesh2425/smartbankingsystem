        ...
        <div class="bg-secondary">
            <div class="container-fluid">
              <ul class="nav secondary-nav">
                ...
                <li class="nav-item"> <a class="nav-link active" href="recharge-bill-electricity"><span><i class="fas fa-lightbulb"></i></span> Electricity</a> </li>
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut" data-animatein="fadeIn" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-6.jpg')}}" alt="banner 5" /></a></div>
                </div>
              </div><!-- Slideshow end -->
