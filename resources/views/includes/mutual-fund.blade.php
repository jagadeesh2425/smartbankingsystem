        ...
        <div class="bg-secondary">
            <div class="container-fluid">
              <ul class="nav secondary-nav">
                ...
                <li class="nav-item"> <a class="nav-link active" href="mutual-fund-and-other-investment-products"><span><i class="fas fa-phone"></i></span> Mutual fund / Investment <br>products</a> </li>
          ...
          <div class="bg-light shadow-md rounded p-4">
            <div class="row">
              ...
              <div class="col-lg-4 mb-4 mb-lg-0">
                <h2 class="text-4 mb-3">Mutual fund & other investment products</h2>
              ...
              <div class="col-lg-8">
                <div class="owl-carousel owl-theme single-slider" data-animateout="fadeOut" data-animatein="fadeIn" data-autoplay="true" data-loop="true" data-autoheight="true" data-nav="true" data-items="1">
                  ...
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-5.jpg')}}" alt="banner 5" /></a></div>
                  <div class="item"><a href="#"><img class="img-fluid" src="{{asset('frontend/images/slider/banner-7.jpg')}}" alt="banner 3" /></a></div>
                </div>
              </div><!-- Slideshow end -->
        ...
        <div class="section pt-4 pb-3">
          <div class="container">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item"> <a class="nav-link active" id="mobile-recharge-tab" data-toggle="tab" href="#mobile-recharge" role="tab" aria-controls="mobile-recharge" aria-selected="true">Mutual fund & other investment products</a> </li>
            ...
            <div class="tab-content my-3" id="myTabContent">
              <div class="tab-pane fade show active" id="mobile-recharge" role="tabpanel" aria-labelledby="mobile-recharge-tab">
                <p>Instant Online Landline Bill Payment Iisque persius interesset his et, in quot quidam persequeris vim, ad mea essent possim iriure. Mutat tacimates id sit. Ridens mediocritatem ius an, eu nec magna imperdiet. Mediocrem qualisque in has. Enim utroque perfecto id mei, ad eam tritani labores facilisis, ullum sensibus no cum. Eius eleifend in quo. At mei alia iriure propriae.</p>
