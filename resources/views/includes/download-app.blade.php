<!-- Mobile App
        ...
        <section class="section pb-0">
                <div class="container">
                  <div class="row">
                    <div class="col-md-5 col-lg-6 text-center"> <img class="img-fluid" alt="" src="{{asset('frontend/images/app-mobile.png')}}"> </div>
                    <div class="col-md-7 col-lg-6">
                      ...
                      <div class="d-flex flex-wrap pt-2"> <a class="mr-4" href=""><img alt="" src="{{asset('frontend/images/app-store.png')}}"></a><a href=""><img alt="" src="{{asset('frontend/images/google-play-store.png')}}"></a> </div>
                    </div>
                  </div>
                </div>
              </section>
