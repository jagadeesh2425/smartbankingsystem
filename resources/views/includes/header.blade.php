          ...
          <div class="container">
            <div class="header-row">
              <div class="header-column justify-content-start"> 
                ...
                <!-- Logo
                ============================================= -->
                <div class="logo"> <a href="index.html" title="Quickai - HTML Template"><img src="{{asset('frontend/images/smart_pay_logo.png')}}" alt="Quickai" width="127" style="height: 117px;" /></a> </div>
                <!-- Logo end --> 
                ...
                <nav class="primary-menu navbar navbar-expand-lg">
                  <div id="header-nav" class="collapse navbar-collapse">
                   ...
                   <!--   <li class="dropdown active"> <a class="dropdown-toggle" href="#">Home</a>
                      ...
                      <li class="active"> <a class="dropdown-toggle" href="{{ url('/') }}">Home</a>
                      <li> <a class="dropdown-toggle" href="#">Banking Services</a>
                      <li> <a class="dropdown-toggle" href="#">Loans Inquiry</a>
